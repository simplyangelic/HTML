! function (e, t) {
    ...
    function l(e, t, n, r) {
        return I(t["offset" + e], t["scroll" + e], n["client" + e], n["offset" + e], n["scroll" + e], J() ? n["offset" + e] + r["margin" + ("Height" === e ? "Top" : "Left")] + r["margin" + ("Height" === e ? "Bottom" : "Right")] : 0)
    }

    function u() {
        var e = document.body,
            t = document.documentElement,
            n = J() && getComputedStyle(t);
        return {
    ...
    function m(e) {
        var t = e.ownerDocument.documentElement,
            n = h(e, t),
            r = I(t.clientWidth, window.innerWidth || 0),
            o = I(t.clientHeight, window.innerHeight || 0),
            i = s(t),
            f = s(t, "left");
        return c({
        ...
        return (p = p.map((function (e, r) {
            ...
            return e.reduce((function (e, t) {
                ...
                return function (e, t, n, r) {
                    ...
                    return "vh" === f || "vw" === f ? ("vh" === f ? I(document.documentElement.clientHeight, window.innerHeight || 0) : I(document.documentElement.clientWidth, window.innerWidth || 0)) / 100 * i : i
                }(e, o, t, n)
            }))
    ...
    for (var U = Math.min, Y = Math.floor, I = Math.max, q = "undefined" != typeof window && "undefined" != typeof document, V = ["Edge", "Trident", "Firefox"], z = 0, G = 0; G < V.length; G += 1)
        if (q && 0 <= navigator.userAgent.indexOf(V[G])) {
            z = 1;
            break
        } var _, X = q && window.Promise ? function (e) {
            var t = !1;
            return function () {
        ...
        J = function () {
            return null == _ && (_ = -1 !== navigator.appVersion.indexOf("MSIE 10")), _
        },
        K = function (e, t) {
        ...
        ie = function () {
            function t(n, r) {
                ...
                }, this.update = X(this.update.bind(this)), this.options = $({}, t.Defaults, i), this.state = {
                    isDestroyed: !1,
                    isCreated: !1,
                    scrollParents: []
                }, this.reference = n && n.jquery ? n[0] : n, this.popper = r && r.jquery ? r[0] : r, this.options.modifiers = {}, Object.keys($({}, t.Defaults.modifiers, i.modifiers)).forEach((function (e) {
                    o.options.modifiers[e] = $({}, t.Defaults.modifiers[e] || {}, i.modifiers ? i.modifiers[e] : {})
    ...
    return ie.Utils = ("undefined" == typeof window ? global : window).PopperUtils, ie.placements = ee, ie.Defaults = {
        placement: "bottom",
        eventsEnabled: !0,
        removeOnDestroy: !1,
        onCreate: function () {},
        ...
        modifiers: {
            ...
            offset: {
                ...
                fn: function (e, t) {
                    var n, r = t.offset,
                        ...
                        s = i.reference,
                        a = o.split("-")[0];
                    return n = P(+r) ? [+r, 0] : R(r, f, s, a), "left" === a ? (f.top += n[0], f.left -= n[1]) : "right" === a ? (f.top += n[0], f.left += n[1]) : "top" === a ? (f.left += n[0], f.top -= n[1]) : "bottom" === a && (f.left += n[0], f.top += n[1]), e.popper = f, e
                },
                offset: 0
            },
            preventOverflow: {
                ...
                fn: function (e, t) {
                    ...
                    var i = t.priority,
                        ...
                        s = {
                            primary: function (e) {
                                var n = f[e];
                                return f[e] < r[e] && !t.escapeWithReference && (n = I(f[e], r[e])), Z({}, e, n)
                            },
                            secondary: function (e) {
                                var n = "right" === e ? "left" : "top",
                                    o = f[n];
                                return f[e] > r[e] && !t.escapeWithReference && (o = U(f[n], r[e] - ("right" === e ? f.width : f.height))), Z({}, n, o)
                            }
                        };
            ...
            arrow: {
                ...
                fn: function (e, n) {
                    ...
                    return O = I(U(s[l] - g, O), 0), e.arrowElement = o, e.offsets.arrow = (Z(r = {}, d, Math.round(O)), Z(r, h, ""), r), e
                },
                element: "[x-arrow]"
            },
            flip: {
                ...
                fn: function (e, t) {
                    ...
                    return f.forEach((function (s, a) {
                        ...
                        }(i)), e.placement = r + (i ? "-" + i : ""), e.offsets.popper = $({}, e.offsets.popper, x(e.instance.popper, e.offsets.reference, e.placement)), e = T(e.instance.modifiers, e, "flip"))
                    })), e
                },
                behavior: "flip",
                padding: 5,
            ...
            computeStyle: {
                ...
                fn: function (e, t) {
                    ...
                    return e.attributes = $({}, w, e.attributes), e.styles = $({}, u, e.styles), e.arrowStyles = $({}, e.offsets.arrow, e.arrowStyles), e
                },
                gpuAcceleration: !0,
                x: "bottom",
                y: "right"
